package com.liyuhang.ThinkingInJava.containers;//: containers/TypesForSets.java
...
public class TypesForSets {
  static <T> Set<T> fill(Set<T> set, Class<T> type) {
    try {
      for(int i = 0; i < 10; i++)
        //        getConstructor()获取此类型的构造器，入参是构造器的参数列表的类型，
  ...
  public static void main(String[] args) {
    //Java遍历HashSet为什么输出是有序的？https://www.zhihu.com/question/28414001/answer/40733996
